...
public class TESREjector extends TileEntitySpecialRenderer<TileEjector> {
	...
	@Override
	public void render(TileEjector tile, double x, double y, double z, float partialTicks, int destroyStage, float tileAlpha){
		if (tile != null){
            ...
            if (tile.south == TileEjector.EnumConnection.LEVER){
