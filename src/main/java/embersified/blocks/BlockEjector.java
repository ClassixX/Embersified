...
public class BlockEjector extends BlockTEBase{
...
public static final PropertyDirection facing = PropertyDirection.create("facing");
	...
	public void onBlockAdded(World world, BlockPos pos, IBlockState state){
		if (world.getTileEntity(pos) instanceof TileEjector){
			((TileEjector)world.getTileEntity(pos)).updateNeighbors(world);
		}
	}
	...
	public void neighborChanged(IBlockState state, World world, BlockPos pos, Block block, BlockPos fromPos){
		...
		if (t instanceof TileEjector){
			((TileEjector)t).updateNeighbors(world);
			t.markDirty();
		}
